...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/antares/src/catkin_space/git/src/RoboND-Kinematics-Project/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/antares/src/catkin_space/git/devel)
  ...
  set(gazebo_grasp_plugin_INSTALL_PREFIX /home/antares/src/catkin_space/git/install)
...
if(NOT "/home/antares/src/catkin_space/git/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/antares/src/catkin_space/git/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/antares/src/catkin_space/git/src/RoboND-Kinematics-Project/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/antares/src/catkin_space/git/devel/lib;/opt/ros/kinetic/lib)
